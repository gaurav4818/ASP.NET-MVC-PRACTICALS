...
namespace Practical_13.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            //return View(db.Employees.Where(x => x.Name.Contains(search) || search == null).ToList().ToPagedList(page ?? 1, 3));
            return View(db.Employees.ToList().ToPagedList(Page??1,10));
        }
        ...
        {
            var emp = db.Employees.Where(x => x.Name.Contains(eName));
